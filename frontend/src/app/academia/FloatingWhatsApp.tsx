...
export default function FloatingWhatsApp({ href }: { href: string }) {
  ...
  return (
    <a
      ...
      className={`fixed bottom-5 right-5 z-40 flex items-center gap-2.5 rounded-full border border-cyan/30 bg-dark-blue/90 backdrop-blur-sm py-3 pl-4 pr-5 text-cyan font-semibold shadow-2xl shadow-black/40 glow-cyan-hover transition-all duration-300 hover:bg-cyan/15 ${
        visible
